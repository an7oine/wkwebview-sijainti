// Oman sijainnin määritys Javascript-kontekstissa (navigator.geolocation).
//
// Ks. https://newbedev.com/how-to-prevent-wkwebview-to-repeatedly-ask-for-permission-to-access-location
//
// Huomaa, että puukotus on tässä tehty Geolocation-luokan prototyyppiin.
        ...
        success: function(timestamp, latitude, longitude, altitude, accuracy, altitudeAccuracy, heading, speed) {
          var position = {
            timestamp: new Date(timestamp).getTime() || new Date().getTime(),
                    // safari can not parse date format returned by swift e.g. 2019-12-27 15:46:59 +0000 (fallback used because we trust that safari will learn it in future because chrome knows that format)
            coords: {
              latitude: latitude,
              longitude: longitude,
              altitude: altitude,
